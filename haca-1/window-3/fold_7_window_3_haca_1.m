function [errsTrainFalsePos,errsTrainFalseNeg,errsTestFalsePos,errsTestFalseNeg] = fold_7_window_3_haca_1()
% Initial values
%tic;
M = 200;
...
[tX,tT,tH] = FEAT_fold_7_window_3_haca_1_train();
[hX,hT,hH] = FEAT_fold_7_window_3_haca_1_hold();
...
%profile viewer
%toc;
%save fold_7_window_3_haca_1_model model
