function [errsTrainFalsePos,errsTrainFalseNeg,errsTestFalsePos,errsTestFalseNeg] = fold_4_window_2_cd_1()
% Initial values
%tic;
M = 200;
...
[tX,tT,tH] = FEAT_fold_4_window_2_cd_1_train();
[hX,hT,hH] = FEAT_fold_4_window_2_cd_1_hold();
...
%profile viewer
%toc;
%save fold_4_window_2_cd_1_model model
